...
if __name__ == "__main__":
    ...
    while l_flipped_counter < 0.05*SET_LENGTH:
        ...
        if low_noise_labels[rand_instance_index] == MAJ_LABEL:
            if randint(0,100) < 3+(30 if i[rand_instance_index][1]==MIN_LABEL else 0):
                print('Mislabel rate: ', 3+(30 if i[rand_instance_index][1]==MIN_LABEL else 0))
    ...
    while h_flipped_counter < 0.05*SET_LENGTH:
        ...
        if high_noise_labels[rand_instance_index] == MAJ_LABEL:
            if randint(0,100) < 5+(50 if i[rand_instance_index][1]==MIN_LABEL else 0):
                print('Mislabel rate: ', 5+(50 if i[rand_instance_index][1]==MIN_LABEL else 0))
